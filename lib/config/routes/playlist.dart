...
import 'package:haydikids/utils/players/youtubePlayer.dart';
...
import 'package:haydikids/config/routes/components/playlist/pageDetails.dart';
import 'package:haydikids/config/routes/components/playlist/videosListview.dart';
import 'package:youtube_explode_dart/youtube_explode_dart.dart';

class YoutubePlayerPlaylistPage extends StatefulWidget {
  @override
  _YoutubePlayerPlaylistPageState createState() =>
      _YoutubePlayerPlaylistPageState();
}
                ...
                child: AnimatedSwitcher(
                    ...
                    child: manager.mediaInfoSet.playlistVideos.isEmpty
                        ...
                        : PlaylistVideosListView(
                            ...
                            onDismiss: (int index) {
                              manager.mediaInfoSet.playlistVideos
                                  .removeAt(index);
                              setState(() {});
                            },
                            onVideoTap: (int index) {
                              String url = manager
                                  .mediaInfoSet.playlistVideos[index].url;
                              manager.updateStreamManifestPlayer(
                                  VideoId.fromString(url));
                            })),
              ),
            ],
          ),
              ...
              ? FloatingActionButton.extended(
                  onPressed: () async {
                    downloadsProvider.handlePlaylistDownload(
                        ...
                        config: Provider.of<ConfigurationProvider>(context,
                            listen: false),
                        listVideos: manager.mediaInfoSet.playlistVideos,
                        album:
                            manager.mediaInfoSet.mediaTags.albumController.text,
                        artist: manager
                            .mediaInfoSet.mediaTags.artistController.text
                            .replaceAll("- Topic", "")
                            .trim());
