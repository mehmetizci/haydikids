        ...
        child: ListView(physics: BouncingScrollPhysics(), children: [
          AnimatedSize(
            ...
            child: AnimatedSwitcher(
              duration: Duration(milliseconds: 400),
              child: downloadsProvider.convertingList.isNotEmpty
                  ? Column(
                      children: [
                        Align(
          ...
          AnimatedSize(
            ...
            child: AnimatedSwitcher(
              duration: Duration(milliseconds: 400),
              child: downloadsProvider.downloadingList.isNotEmpty
                  ? Column(
                      children: [
                        Align(
                          alignment: Alignment.centerLeft,
                            ...
                            return Padding(
                                ...
                                child: StreamBuilder<Object>(
                                    ...
                                    builder: (context, snapshot) {
                                      return DownloadTile(
                                          dataProgress:
                                              infoset.dataProgress.stream,
                                          progressBar:
                                              infoset.progressBar.stream,
                                          currentAction:
                                              infoset.currentAction.stream,
                                          metadata: infoset.metadata,
                                          downloadType: infoset.downloadType,
                                          videoDetails: infoset.videoDetails,
                                          onDownloadCancel: snapshot.data ==
                                                  DownloadStatus.Downloading
                                              ? () {
                                                  infoset.cancelDownload = true;
                                                }
                                              : null,
                                          cancelDownloadIcon: snapshot.data ==
                                                  DownloadStatus.Downloading
          ...
          AnimatedSize(
            ...
            child: AnimatedSwitcher(
              duration: Duration(milliseconds: 400),
              child: downloadsProvider.queueList.isNotEmpty
                  ? Column(
                      children: [
                        Align(
                          alignment: Alignment.centerLeft,
