...
import 'package:haydikids/screens/libraryScreen/components/settings/dialogs/accentPicker.dart';
    ...
    return SettingsColumnTile(
      ...
      children: <Widget>[
        ListTile(
          ...
          subtitle: Text(
            Languages.of(context).labelUseSystemThemeJustification,
        ...
        AnimatedSize(
            ...
            child: config.systemThemeEnabled == false
                ? ListTile(
                    onTap: () =>
                        config.darkThemeEnabled = !config.darkThemeEnabled,
                    title: Text(
                    ...
                    subtitle: Text(
                      Languages.of(context).labelEnableDarkThemeJustification,
                      style: TextStyle(fontSize: 12),
                    ),
                    trailing: CircularCheckBox(
                      activeColor: Theme.of(context).accentColor,
        ...
        ListTile(
          ...
          subtitle: Text(
            Languages.of(context).labelEnableBlackThemeJustification,
            style: TextStyle(fontSize: 12),
          ),
          trailing: CircularCheckBox(
            activeColor: Theme.of(context).accentColor,
        ...
        ListTile(
            ...
            subtitle: Text(
              Languages.of(context).labelAccentColorJustification,
              style: TextStyle(fontSize: 12),
            ),
            trailing: Container(
