...
// Packages
import 'package:haydikids/screens/mediaScreen/dialogs/optionsMenuDialog.dart';
import 'package:transparent_image/transparent_image.dart';
import 'package:audio_service/audio_service.dart';
import 'package:provider/provider.dart';

// UI
import 'package:haydikids/screens/mediaScreen/components/downloads/downloadsEmpty.dart';
    ...
    return ListTile(
          ...
          showDialog(
              ...
              builder: (context) => MediaOptionsMenuDialog(
                    ...
                    onDelete: () async {
                      ...
                      downloadsProvider.databaseSongs.removeAt(downloadsProvider
                          .databaseSongs
                          .indexWhere((file) => file == song));
      ...
      onTap: () async {
        if (song.extras["downloadType"] == "Audio") {
          ...
          if (listEquals(downloadsProvider.databaseSongs, AudioService.queue) ==
              false) {
            await AudioService.updateQueue(downloadsProvider.databaseSongs);
          }
          await AudioService.playMediaItem(
              downloadsProvider.databaseSongs[index]);
        } else {
          Navigator.push(
              context,
              MaterialPageRoute(
